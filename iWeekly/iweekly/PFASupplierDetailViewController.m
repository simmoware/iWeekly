//
//  PFASupplierDetailViewController.m
//  iWeekly
//
...
@interface PFASupplierDetailViewController ()

@end

@implementation PFASupplierDetailViewController
...
- (void)viewDidLoad {
    ...
    if (![self.productIdentifier isEqualToString:@"ALL"]) {
        [request start:@"/GetPODetailsBySupplierAndDes" withParams:@{@"product":self.productIdentifier, @"supplier":self.supplierName}];
    } else {
        [request start:@"/GetPODetailsBySuppAndAll" withParams:@{@"supplier":self.supplierName}];
    }
    ...
    [self setTitle:[NSString stringWithFormat:@"%@ - %@", self.supplierName, self.productIdentifier]];
}
