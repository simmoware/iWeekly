...
@interface PFACappsViewController ()

@end

@implementation PFACappsViewController
...
- (void)viewDidLoad {
    ...
    if (web == nil) {
        ...
        [web loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://connectedapps.com.au"]]];
    }
    [self setTitle:@"Apps, Websites, Branding & Social Media | Connected Apps"];
}
